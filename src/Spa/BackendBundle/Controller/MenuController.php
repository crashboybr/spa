...
use Spa\BackendBundle\Entity\Menu;
use Spa\BackendBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SpaBackendBundle:Menu')->findAll();

        return $this->render('SpaBackendBundle:Menu:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SpaBackendBundle:Menu:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SpaBackendBundle:Menu')->find($id);
        ...
        return $this->render('SpaBackendBundle:Menu:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SpaBackendBundle:Menu:edit.html.twig', array(
            'entity'      => $entity,
